...
/// because the value used to be repeated as a literal in each writer overload,
/// and the copies drifted: <see cref="BcsvWriter.Open"/> moved to the current
/// default while <see cref="BcsvColumns.WriteColumns"/> kept writing level 1,
/// so the same data compressed differently depending on which API you called.
/// Every managed default must reference these, never a literal.
/// </remarks>
